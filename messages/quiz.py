...
@router.message(F.text.in_(["Yangi CV/Rezyume yaratish", "Create a new CV/Resume", "Создать новое резюме"]))
...
@router.message(UserStates.user_full_name)
...
@router.message(UserStates.user_location)
...
@router.message(UserStates.user_phone_number)
...
@router.message(UserStates.user_email)
...
@router.message(UserStates.user_proffesion)
...
@router.message(UserStates.edu_name)
...
@router.message(UserStates.edu_years)
...
@router.message(UserStates.edu_field)
...
@router.message(UserStates.edu_again)
...
@router.message(UserStates.user_skills)
...
@router.callback_query(F.data == "skip_links")
...
@router.message(UserStates.user_links)
...
@router.message(UserStates.user_language)
...
@router.message(UserStates.user_about)
...
@router.message(UserStates.work_name)
...
@router.message(UserStates.work_years)
...
@router.message(UserStates.work_field)
...
@router.message(UserStates.work_more)
...
@router.message(UserStates.work_again)
